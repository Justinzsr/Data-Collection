...
export const tiktokConnector: ConnectorDefinition = {
  ...
  getSetupInstructions(source) {
    ...
    return [
      ...
      "MoonArq uses MOONARQ_TIKTOK_CLIENT_KEY, MOONARQ_TIKTOK_CLIENT_SECRET, MOONARQ_TIKTOK_REDIRECT_URI, and optionally MOONARQ_TIKTOK_API_BASE_URL when configured; otherwise it falls back to the default TikTok app profile.",
