...
export const tiktokConnector: ConnectorDefinition = {
  ...
  getSetupInstructions(source) {
    ...
    return [
      ...
      "By default, TikTok sources use TIKTOK_CLIENT_KEY, TIKTOK_CLIENT_SECRET, TIKTOK_REDIRECT_URI, and optionally TIKTOK_API_BASE_URL.",
      "A source can explicitly opt into MOONARQ_TIKTOK_CLIENT_KEY, MOONARQ_TIKTOK_CLIENT_SECRET, MOONARQ_TIKTOK_REDIRECT_URI, and optionally MOONARQ_TIKTOK_API_BASE_URL after that TikTok app profile is ready.",
